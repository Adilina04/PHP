...
require_once __DIR__ . '/actions/RegisterForm.php';
...
?>
    <div class="regis_div">
        ...
        <form action="<?php echo $_SERVER[
            ...
            <button name="subm_user" type="submit">Envoyer</button><a href="login.php" class="reglink">Connexion</a>
        </form>
    </div>
